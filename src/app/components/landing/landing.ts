  ...
  readonly imageGallery = [
    {
      ...
      description: 'The public-facing landing view introduces the lab brand, value proposition, and staff access entry points.',
      image: '/Screenshot%20from%202026-08-06%2000-44-22.png',
    },
    {
      title: 'Clinical departments',
      section: 'Diagnostic departments',
      description: 'This screen highlights core laboratory specialties such as hematology, chemistry, and serology services.',
      image: '/Screenshot%20from%202026-08-06%2000-45-08.png',
    },
    {
      title: 'Test catalog',
      section: 'Test directory',
      description: 'The test catalog presents available panels with specimen requirements, turnaround time, and reference details.',
      image: '/Screenshot%20from%202026-08-06%2000-45-27.png',
    },
    {
      title: 'Clinical standards',
      section: 'Quality assurance',
      description: 'This view reinforces the laboratory’s quality standards, automated flagging rules, and reporting precision.',
      image: '/Screenshot%20from%202026-08-06%2000-45-49.png',
    },
    {
      title: 'Dashboard overview',
      section: 'Operations dashboard',
      description: 'The dashboard summarizes patient counts, urgent cases, completed records, and recent diagnostic activity.',
      image: '/Screenshot%20from%202026-08-06%2000-47-20.png',
    },
    {
      title: 'Patient intake form',
      section: 'Patient registration',
      description: 'The patient form captures personal details, clinical context, tests requested, and doctor information.',
      image: '/Screenshot%20from%202026-08-06%2000-47-53.png',
    },
    {
      title: 'Patient record list',
      section: 'Patient management',
      description: 'The records page provides a structured list of registered patients and their current laboratory status.',
      image: '/Screenshot%20from%202026-08-06%2000-48-23.png',
    },
    {
      title: 'Test result entry',
      section: 'Result review',
      description: 'This screen supports entering parameter values, reviewing normal ranges, and flagging abnormal findings.',
      image: '/Screenshot%20from%202026-08-06%2000-48-45.png',
    },
    {
      title: 'Lab report preview',
      section: 'Reporting module',
      description: 'The report view prepares a doctor-ready summary that can be printed or shared after completion.',
      image: '/Screenshot%20from%202026-08-06%2000-49-22.png',
    },
    {
      title: 'Secure staff access',
      section: 'Login portal',
      description: 'The login screen provides controlled access to the staff dashboard, patient workflows, and report tools.',
      image: '/Screenshot%20from%202026-08-06%2000-50-02.png',
    },
    {
      title: 'Navigation system',
      section: 'Shared layout',
      description: 'The shared navigation keeps the experience consistent across the landing, dashboard, and patient modules.',
      image: '/Screenshot%20from%202026-08-06%2000-50-32.png',
    },
    {
      title: 'Lab workflow review',
      section: 'Operational workflow',
      description: 'This illustration captures the broader diagnostic workflow from intake through analysis and reporting.',
      image: '/Screenshot%20from%202026-08-06%2000-51-35.png',
    },
    {
      title: 'Clinical reporting suite',
      section: 'End-to-end experience',
      description: 'This screen ties together the public lab experience and the staff-facing reporting tools in one view.',
      image: '/Screenshot%20from%202026-08-06%2000-51-35.png',
    },
  ];
